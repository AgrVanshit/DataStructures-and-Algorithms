...
public:
    void nextPermutation(vector<int>& nums) {
        ...
        /*Iterating from the back and finding first element smaller than its next element, 
        before that element all the elements from index 0 to that element's index will match
